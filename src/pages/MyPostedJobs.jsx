...
const MyPostedJobs = () => {
  ...
  // custom tosat delet funtionality

  const handleMordernDelet = (id) => {
    toast((t) => (
      <div>
        <div className="flex gap-3 items-center">
          ...
          <div className="flex items-center gap-2">
            ...
            <button className="btn btn-sm bg-green-500 text-white" onClick={() => toast.dismiss(t.id)}>
              Cancel
            </button>
          </div>
        </div>
                ...
                <tbody className="bg-white divide-y divide-gray-200 ">
                  {jobs.map((job) => (
                    <tr key={job._id}>
                      ...
                      <td className="px-4 py-4 text-sm text-gray-500  whitespace-nowrap">
                        ${job.min_price}-$600{job.max_price}
                      </td>
                      ...
                      <td className="px-4 py-4 text-sm whitespace-nowrap">
                        <div className="flex items-center gap-x-6">
                          <button
                            onClick={() => handleMordernDelet(job._id)}
